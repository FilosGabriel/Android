...
public class Lab6 extends AppCompatActivity implements SensorEventListener, LocationListener {
    ...
    protected void onResume() {
        super.onResume();
        mSensorManager.registerListener(this, mAccelerometer, SENSOR_DELAY_NORMAL, 1000000);
        mSensorManager.registerListener(this, mGyroscope, SENSOR_DELAY_NORMAL, 1000000);
    }
